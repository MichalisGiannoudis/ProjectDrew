...
export const TimeLine = () => {
    ...
    <div>
        <div className="hidden lg:block relative mx-auto py-16 px-4 w-[75%]">
        ...
        <div className="grid lg:hidden relative py-30 md:py-20">
            ...
            <div className="grid z-20 h-200 md:h-160 grid-cols-1 gap-50 md:gap-30 w-screen">
                ...
                <div key={index} className="flex items-center animate-fade-in-up cursor-default" style={{ animationDelay: `${index * 200}ms` }}>
                    ...
                    <div className="absolute transform -translate-x-1/2 ml-15 md:ml-25">
                        <div className="w-6 h-6 bg-gray-800 rounded-full border-4 border-white shadow-lg transform transition-all duration-300 hover:scale-125 hover:shadow-xl hover:shadow-blue-500/30 cursor-pointer z-30">
                            <div className="absolute top-1/2 left-1/2 w-2 h-2 bg-white/80 rounded-full transform -translate-x-1/2 -translate-y-1/2"></div>
                        </div>
                    </div>

                    <div className="absolute transform -translate-x-1/2 ml-3 md:ml-12 text-xl font-bold text-gray-200 bg-clip-text tracking-wide">
                        {milestone.yearLabel}
                    </div>
                </div>
                ))}     
