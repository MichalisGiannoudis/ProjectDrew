export const ServiceCard = ({ serviceImage, serviceLabel, serviceBody }: { serviceImage:string,serviceLabel: string, serviceBody:string }) => {
    return(
        <div className="relative">
            <div className="bg-white flex flex-col rounded-lg shadow-lg p-8 pt-12 text-center hover:shadow-2xl transition-shadow duration-300 h-auto md:h-150 lg:h-130">
                ...
                <div className="flex flex-col gap-4 text-center items-start">
