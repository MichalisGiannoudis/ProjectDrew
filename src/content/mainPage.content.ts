export const MainPageContentEN = {
    ...
    exp1Label: 'Corporate Law',
    exp2Label: 'Civil Litigation',
    exp3Label: 'Legal Advisory Services',
    exp4Label: 'Contract Drafting and Review',
    exp5Label: 'Dispute Resolution',
}
...
export const MainPageContentGR = {
    ...
    exp1Label: 'Εταιρικό Δίκαιο',
    exp2Label: 'Πολιτική Δικαστική Διαμάχη',
    exp3Label: 'Νομικές Συμβουλευτικές Υπηρεσίες',
    exp4Label: 'Σύνταξη και Ανασκόπηση Συμβάσεων',
    exp5Label: 'Επίλυση Διαφορών',
}