export const MainPageContentEN = {
    ...
    serviceBody7: 'From/To Greek - German - English',
...
export const MainPageContentGR = {
    ...
    serviceLabel7: 'Μεταφράσεις & επικυρώσεις εγγράφων',
    ...
    serviceBody7: 'Από/προς Ελληνικά - Γερμανικά - Αγγλικά',
    ...
    contactSurnNamePlaceholder: 'Παπαδόπουλος',
